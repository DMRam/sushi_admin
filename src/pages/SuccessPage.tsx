...
export default function SuccessPage() {
    ...
    useEffect(() => {
        ...
        // You could also fetch order details using the sessionId
        if (sessionId) {
            // Optional: Call a backend function to get order details
            ...
            <div className="container mx-auto px-6">
                <div className="max-w-md mx-auto text-center">
                    <div className="bg-white/5 border border-white/10 rounded-sm p-8 backdrop-blur-sm">
                        ...
                        <h2 className="text-2xl font-light text-white mb-3 tracking-wide">Payment Successful!</h2>
                        ...
                        {sessionId && (
                            <div className="bg-white/5 rounded-sm p-4 mb-6 border border-white/10">
                                <p className="text-xs text-white/40 font-light tracking-wide mb-1">Order Reference</p>
