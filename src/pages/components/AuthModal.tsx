...
>
  <div
    className="relative bg-gradient-to-br from-black to-gray-900 border border-white/10 rounded-2xl p-8 w-full max-w-md text-center shadow-2xl"
  ...
  >
    ...
    {/* Icon */}
    <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#E62B2B]/10 flex items-center justify-center border border-[#E62B2B]/30">
    ...
    <p className="text-white/60 text-sm mb-6 leading-relaxed">
      We're cooking something special for you.
      <br />
      Accounts, rewards & faster checkout will be available soon.
    </p>

    {/* Cool progress bar */}
    <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden mb-6">
      <div className="h-full w-2/3 bg-[#E62B2B] animate-pulse rounded-full"></div>
    </div>

    {/* CTA */}
    <button
      onClick={() => setShowAuthModal(false)}
      className="bg-[#E62B2B] text-white px-6 py-3 rounded-xl hover:bg-[#ff4444] transition font-medium w-full"
    >
      Continue browsing
    </button>
