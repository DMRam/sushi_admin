...
export default function BuildYourSushi({ isOpen, onClose }: BuildYourSushiProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md p-4">
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-white/10 bg-gradient-to-br from-[#111] to-[#1a1a1a] shadow-2xl overflow-hidden">
        <button
          onClick={onClose}
        ...
        <div className="p-8 text-center">
          <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-[#E62B2B]/10 border border-[#E62B2B]/20 flex items-center justify-center">
            <ChefHat className="w-8 h-8 text-[#E62B2B]" />
          </div>
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/60 text-xs mb-4">
            <Sparkles className="w-3.5 h-3.5 text-[#E62B2B]" />
            New experience in preparation
          </div>

          <h2 className="text-2xl font-semibold text-white mb-3">
            Build Your Sushi — Coming Soon
          </h2>

          <p className="text-white/65 text-sm leading-relaxed mb-6">
            We’re preparing a better custom experience for you.
            Soon you’ll be able to create your own sushi step by step.
          </p>

          <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden mb-6">
            <div className="h-full w-2/3 bg-[#E62B2B] rounded-full animate-pulse" />
          </div>

          <button
            onClick={onClose}
            className="w-full rounded-xl bg-[#E62B2B] hover:bg-[#ff4444] text-white font-medium py-3 transition-colors"
          >
            Continue browsing
          </button>
