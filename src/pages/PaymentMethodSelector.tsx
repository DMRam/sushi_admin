    ...
    return (
        <div className="bg-white/5 border border-white/10 rounded-sm p-6">
            ...
            <div className="space-y-4 mb-6">
                ...
                <label className="flex items-start space-x-3 cursor-pointer group p-4 rounded-sm border transition-all duration-200 hover:bg-white/5"
                    style={{
                        borderColor: paymentMethod === "cash" ? 'rgba(255,255,255,0.3)' : 'rgba(255,255,255,0.1)',
                        backgroundColor: paymentMethod === "cash" ? 'rgba(255,255,255,0.1)' : 'transparent'
                    }}
                >
                    <div className="flex items-center h-5 mt-0.5">
                        <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center transition-all duration-200 ${paymentMethod === "cash" ? 'border-white bg-white' : 'border-white/30'}`}>
                            {paymentMethod === "cash" && (
                                <div className="w-2 h-2 rounded-full bg-gray-900"></div>
                            )}
                        </div>
