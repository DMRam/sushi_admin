...
class ErrorBoundaryWrapper extends React.Component<{ children: React.ReactNode; onError: () => void }> {
    componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
        console.error('OrderSummary Error:', error, errorInfo);
        this.props.onError();
    }
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-end space-y-2 flex-shrink-0">
                                        <div className="flex items-center space-x-1 bg-white/5 rounded-sm border border-white/10 p-1">
                                            ...
                                            <span className="w-6 text-center font-light text-white text-sm mx-1">
                                                {safeQuantity}
                                            </span>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="w-full bg-white/10 rounded-full h-2">
                                    <div
                                        ...
                                        style={{ width: `${Math.min((safeCartTotal / 25) * 100, 100)}%` }}
                                    />
                                </div>
                            </div>
                        )}
